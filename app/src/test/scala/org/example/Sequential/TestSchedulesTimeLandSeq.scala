...
class TestSchedulesTimeLandSeq extends AnyFunSuite{
  ...
  test("Test schedulesTimeLand 1") {
    val its1 = itoObj.schedulesTimeLand(vuelosCurso, aeropuertosCurso)("MID", "SVCS")
    assert(its1 === List(
  ...
  test("Test schedulesTimeLand 2") {
    val its2 = itoObj.schedulesTimeLand(vuelosCurso, aeropuertosCurso)("CLO", "SVCS")
    assert(its2 === List())
  }

  test("Test schedulesTimeLand 3") {
    val its3 = itoObj.schedulesTimeLand(vuelosCurso, aeropuertosCurso)("CLO", "SVO")
    assert(its3 === List(
  ...
  test("Test schedulesTimeLand 4") {
    val its4 = itoObj.schedulesTimeLand(vuelosCurso, aeropuertosCurso)("CLO", "MEX")
    assert(its4 === List(
      Itinerario(List(Vuelo("AVA", 9432, "CLO", 7, 0, "BOG", 8, 0, 0),
  ...
  test("Test schedulesTimeLand 5") {
    val its5 = itoObj.schedulesTimeLand(vuelosCurso, aeropuertosCurso)("CTG", "PTY")
    assert(its5 === List(
