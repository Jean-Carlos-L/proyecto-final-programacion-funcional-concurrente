...
class TestSchedulesSeq extends AnyFunSuite {
  ...
  val itsCurso: (String, String) => List[Itinerario] = itoObj.schedules(vuelosCurso, aeropuertosCurso)
  val itsCurso15: (String, String) => List[Itinerario] = itoObj.schedules(vuelosA1, aeropuertos)
  val itsCurso40: (String, String) => List[Itinerario] = itoObj.schedules(vuelosB1, aeropuertos)
  val itsCurso100: (String, String) => List[Itinerario] = itoObj.schedules(vuelosC1, aeropuertos)
  ...
  test("test6") {
    ...
    assert(its6 === List(List(Vuelo("4X", 373, "HOU", 13, 15, "MSY", 15, 10, 1),
      ...
      List(Vuelo("4X", 216, "HOU", 14, 30, "MSY", 18, 10, 3),
        Vuelo("AA", 828, "MSY", 17, 10, "BNA", 18, 37, 0)),
      List(Vuelo("4X", 375, "HOU", 18, 20, "MSY", 10, 15, 1),
        Vuelo("AA", 828, "MSY", 17, 10, "BNA", 18, 37, 0)),
      List(Vuelo("4X", 214, "HOU", 9, 0, "MSY", 12, 40, 3),
        Vuelo("AA", 828, "MSY", 17, 10, "BNA", 18, 37, 0)),
      List(Vuelo("4X", 371, "HOU", 8, 35, "MSY", 10, 30, 1),
        Vuelo("AA", 828, "MSY", 17, 10, "BNA", 18, 37, 0))))
  }
