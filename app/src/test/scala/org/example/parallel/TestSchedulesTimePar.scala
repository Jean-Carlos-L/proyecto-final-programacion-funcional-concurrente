...
import datas.{aeropuertos, aeropuertosCurso, vuelosA1, vuelosB1, vuelosCurso, vuelosC1}
import org.example.{FlightSchedulesPar, Vuelo}
...
class TestSchedulesTimePar extends AnyFunSuite{
  ...
  val itsCurso: (String, String) => List[List[Vuelo]] = itoObj.schedulesTime(vuelosCurso, aeropuertosCurso)
  val itsCurso15: (String, String) => List[List[Vuelo]] = itoObj.schedulesTime(vuelosA1, aeropuertos)
  val itsCurso40: (String, String) => List[List[Vuelo]] = itoObj.schedulesTime(vuelosB1, aeropuertos)
  val itsCurso100: (String, String) => List[List[Vuelo]] = itoObj.schedulesTime(vuelosC1, aeropuertos)
