...
class TestSchedulesTimeLandPar extends AnyFunSuite{
  ...
  val itsCurso: (String, String) => List[List[Vuelo]] = itoObj.schedulesTimeLand(vuelosCurso, aeropuertosCurso)
  val itsCurso15: (String, String) => List[List[Vuelo]] = itoObj.schedulesTimeLand(vuelosA1, aeropuertos)
  val itsCurso40: (String, String) => List[List[Vuelo]] = itoObj.schedulesTimeLand(vuelosB1, aeropuertos)
  val itsCurso100: (String, String) => List[List[Vuelo]] = itoObj.schedulesTimeLand(vuelosC1, aeropuertos)
